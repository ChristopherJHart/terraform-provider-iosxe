...
func (data System) toBody(ctx context.Context, config System) string {
	...
	if !data.PowerRedundancyMode.IsNull() && !data.PowerRedundancyMode.IsUnknown() {
		body, _ = sjson.Set(body, helpers.LastElement(data.getPath())+"."+"Cisco-IOS-XE-power:power.redundancy-mode", data.PowerRedundancyMode.ValueString())
	}
...
func (data System) toBodyXML(ctx context.Context, config System) string {
	...
	if !data.PowerRedundancyMode.IsNull() && !data.PowerRedundancyMode.IsUnknown() {
		body = helpers.SetFromXPath(body, data.getXPath()+"/Cisco-IOS-XE-power:power/redundancy-mode", data.PowerRedundancyMode.ValueString())
	}
	if !data.PowerSupplyAutolcShutdown.IsNull() && !data.PowerSupplyAutolcShutdown.IsUnknown() {
		if data.PowerSupplyAutolcShutdown.ValueBool() {
...
func (data *System) updateFromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get(prefix + "Cisco-IOS-XE-power:power.redundancy-mode"); value.Exists() && !data.PowerRedundancyMode.IsNull() {
		data.PowerRedundancyMode = types.StringValue(value.String())
	} else {
		data.PowerRedundancyMode = types.StringNull()
	}
...
func (data *System) updateFromBodyXML(ctx context.Context, res xmldot.Result) {
	...
	if value := helpers.GetFromXPath(res, "data"+data.getXPath()+"/Cisco-IOS-XE-power:power/redundancy-mode"); value.Exists() && !data.PowerRedundancyMode.IsNull() {
		data.PowerRedundancyMode = types.StringValue(value.String())
	} else {
		data.PowerRedundancyMode = types.StringNull()
	}
...
func (data *System) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get(prefix + "Cisco-IOS-XE-power:power.redundancy-mode"); value.Exists() {
		data.PowerRedundancyMode = types.StringValue(value.String())
	}
...
func (data *System) fromBodyXML(ctx context.Context, res xmldot.Result) {
	...
	if value := helpers.GetFromXPath(res, "data"+data.getXPath()+"/Cisco-IOS-XE-power:power/redundancy-mode"); value.Exists() {
		data.PowerRedundancyMode = types.StringValue(value.String())
	}
...
func (data *System) getDeletedItems(ctx context.Context, state System) []string {
	...
	if !state.PowerRedundancyMode.IsNull() && data.PowerRedundancyMode.IsNull() {
		deletedItems = append(deletedItems, fmt.Sprintf("%v/Cisco-IOS-XE-power:power/redundancy-mode", state.getPath()))
	}
...
func (data *System) addDeletedItemsXML(ctx context.Context, state System, body string) string {
	...
	if !state.PowerRedundancyMode.IsNull() && data.PowerRedundancyMode.IsNull() {
		b = helpers.RemoveFromXPath(b, state.getXPath()+"/Cisco-IOS-XE-power:power/redundancy-mode")
	}
	if !state.MldSnoopingQuerier.IsNull() && data.MldSnoopingQuerier.IsNull() {
...
func (data *System) getDeletePaths(ctx context.Context) []string {
	...
	if !data.PowerRedundancyMode.IsNull() {
		deletePaths = append(deletePaths, fmt.Sprintf("%v/Cisco-IOS-XE-power:power/redundancy-mode", data.getPath()))
	}
...
func (data *System) addDeletePathsXML(ctx context.Context, body string) string {
	...
	if !data.PowerRedundancyMode.IsNull() {
		b = helpers.RemoveFromXPath(b, data.getXPath()+"/Cisco-IOS-XE-power:power/redundancy-mode")
	}
	if !data.MldSnoopingQuerier.IsNull() {
