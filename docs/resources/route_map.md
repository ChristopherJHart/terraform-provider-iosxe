...
- `set_communities_additive` (Boolean) - Default value: `false`
- `set_communities_additive_legacy` (Boolean) - Default value: `false`
...
- `set_extcomunity_vpn_distinguisher_additive` (Boolean) - Default value: `false`
- `set_extcomunity_vpn_distinguisher_legacy` (String)
- `set_global` (Boolean) - Default value: `false`
